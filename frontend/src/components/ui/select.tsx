...
// A native <select> styled to match Input, rather than a Radix primitive —
// this project's first dropdown only needs a handful of fixed options
// (Phase 10.7.1's SOM topology picker), which doesn't warrant a new
// dependency yet.
