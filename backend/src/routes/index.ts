...
import { trainingJobRouter, internalTrainingJobRouter } from '../modules/training-jobs/training-job.routes'
...
router.use('/internal/training-jobs', internalTrainingJobRouter)
